...
<body class="fix-header">
    ...
    <div id="main-wrapper">        <?php $hg_admin_page = 'menu_add'; include __DIR__ . '/includes/admin_shell.php'; ?>
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Select Hawker Stall</label>
													<select name="res_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Select Hawker Stall--</option>
                                                 <?php $ssql ="select * from hawkerstalls";
