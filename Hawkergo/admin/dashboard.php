...
<body class="fix-header hg-admin-portal">
    ...
    <div id="main-wrapper">
        ...
        <?php $hg_admin_page = 'dashboard'; include __DIR__ . '/includes/admin_shell.php'; ?>
    
        <div class="page-wrapper">
            <div class="container-fluid">
                <section class="hg-admin-hero">
                    <div class="hg-admin-hero-bg" aria-hidden="true"></div>
                    <div class="hg-admin-hero-inner">
                        <div class="hg-admin-hero-copy">
                            <h2>Welcome, Admin</h2>
                            <p>Manage hawker stalls, orders, customers, and payment issues from one place.</p>
                        </div>
                        <span class="hg-admin-hero-badge"><i class="fa fa-shield"></i> HawkerGo Control Center</span>
                    </div>
                </section>
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from hawkerstalls";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0">Hawker Stalls</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'closed' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Ready for Collection</p>
                                </div>
                            </div>
                        </div>
                    </div>
